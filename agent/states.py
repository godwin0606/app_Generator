...
class Plan(BaseModel):
    ...
    description: str = Field(
        ...
        description = "A online description of the app to be built, e.g. 'A web application for managing personal"
    )
...
class ImplementationTask(BaseModel):
    filepath: str = Field(description="The path to the file to be denoted")
